...
import PingPongDelay from './modules/PingPongDelay.jsx'
...
export default class Container extends Component {
  ...
  handleBassValueChange = (property, value) => {
    ...
    if (property === 'pingPongDelayWet') {
      ...
      bassChorus.type = value
      bassSettings.chorus.type = value
    } else if (property === 'chorusDelayTime') {
      bassChorus.delayTime.value = value
      bassSettings.chorus.delayTime = value
    } else if (property === 'chorusFrequency') {
      bassChorus.frequency = value
      bassSettings.chorus.frequency = value
    } else if (property === 'chorusDepth') {
      bassChorus.depth = value
      bassSettings.chorus.depth = value
